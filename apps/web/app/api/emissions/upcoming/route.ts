...
// Mirror of the Zustand seed so the API is always available server-side.
// If a CMS or DB is wired later, swap this constant for a DB call.
const UPCOMING_EMISSIONS: UpcomingEmission[] = [
  {
    id: 'em-001',
    ...
    status: 'premarketing',
    description:
      "Autocall Phoenix indexé sur Euro Stoxx 50 avec coupon mémoire de 7.2% par an et barrière de protection à 60%.",
  },
  {
    id: 'em-002',
  ...
  },
  {
    ...
    status: 'premarketing',
    description:
      'Note à barrière sur Nasdaq 100 avec coupon trimestriel conditionnel 8.8%.',
  },
  {
    id: 'em-005',
...
export function GET(): Response {
  return NextResponse.json({
    data: UPCOMING_EMISSIONS,
    total: UPCOMING_EMISSIONS.length,
  });
}
